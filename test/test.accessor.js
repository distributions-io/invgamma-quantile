...
describe( 'accessor quantile', function tests() {
	...
	it( 'should evaluate the quantile function of the Inverse Gamma distribution using an accessor', function test() {
		...
		actual = quantile( actual, data, alpha, beta,getValue );
