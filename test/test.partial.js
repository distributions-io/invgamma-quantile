...
describe( 'partial quantile', function tests() {
	...
	it( 'should partially apply the quantile function of the Inverse Gamma distribution for given parameter values', function test() {
		var quantile;
		quantile = partial( alpha, beta );
	...
	it( 'should return `NaN` if provided `NaN` as input', function test() {
		var quantile = partial(  alpha, beta );
