...
``` bash
$ npm install distributions-invgamma-quantile
```
...
A [Inverse Gamma](https://en.wikipedia.org/wiki/Inverse Gamma_distribution) distribution is a function of 2 parameter(s): `alpha`(shape parameter) and `beta`(scale parameter). By default, `alpha` is equal to `1` and `beta` is equal to `1`. To adjust either parameter, set the corresponding option(s).
...
[npm-image]: http://img.shields.io/npm/v/distributions-invgamma-quantile.svg
[npm-url]: https://npmjs.org/package/distributions-invgamma-quantile
...
[dev-dependencies-image]: http://img.shields.io/david/dev/distributions-io/invgamma-quantile.svg
[dev-dependencies-url]: https://david-dm.org/dev/distributions-io/invgamma-quantile

[github-issues-image]: http://img.shields.io/github/issues/distributions-io/invgamma-quantile.svg
[github-issues-url]: https://github.com/distributions-io/invgamma-quantile/issues
